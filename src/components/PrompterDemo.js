...
import { Cue } from './Cue';
// Uncomment below to use mock voice input for testing purposes
  ...
  return (
    <SpeechRecognitionProvider>
      <Prompter linkShowing={linkShowing}>
        Hi Ghost! Thanks for letting me demo this for you. As I mentioned, this little app allows
        you to read text, and add scripted actions to any word in the text. For example, we can
        change the <Cue callback={() => changeColor('#fbeaeb', '#2f3c7e')}>color</Cue> to make it
        look a little more interesting. But it&apos;s not limited to color changes. After you read{' '}
